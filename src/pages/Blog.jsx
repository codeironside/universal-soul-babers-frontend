    ...
    <div className="relative bg-gray-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative">
          {isLoading &&
            <div
              className="absolute top-0 left-0 w-full h-full bg-white bg-opacity-70 flex justify-center items-center">
              <FaSpinner className="w-16 h-16  text-primaryDark animate-spin"/>
            </div>
          }

          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mt-12">All posts</h2>
          <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
            {posts.map((post) => (<div key={post.title} className="flex flex-col overflow-hidden rounded-lg shadow-lg">
              <div className="flex-shrink-0">
                <img className="h-48 w-full object-cover" src={post.imageUrl} alt=""/>
              </div>
              <div className="flex flex-1 flex-col justify-between bg-white p-6">
