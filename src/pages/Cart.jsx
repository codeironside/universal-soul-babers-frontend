    ...
    <li key={product._id} className="flex py-6 sm:py-10">
      {product?.items.map((item) => (
        <React.Fragment key={item._id}>
          ...
          >
            <h2 id="summary-heading" className="text-lg font-medium text-gray-900" onClick={()=> console.log(cart[4].totalAmount)}>
              Order summary
            </h2>
            ...
            <dl className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">${cart[4]?.totalAmount}</dd>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                <dd className="text-base font-medium text-gray-900">${cart[4]?.totalAmount}</dd>
              </div>
            </dl>
