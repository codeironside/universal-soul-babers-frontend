          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-warm-gray-500">
                Have a question or need assistance? We're here to help! Feel free to reach out to us through the contact details provided below. Whether it's a query about our services, scheduling an appointment, or any other concern, we're committed to providing you with prompt and personalized support. Your satisfaction is our priority, and we look forward to hearing from you soon.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                {/* Contact information */}
                <div className="relative overflow-hidden bg-gradient-to-b from-primaryColor to-black py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-white">
                      ...
                      <span className="ml-3">800-747-1610</span>
                    </dd>
                    <dt>
                    ...
                    <dd className="flex text-base text-white">
                      ...
                      <span className="ml-3">vip@universoulbarbers.com</span>
                    </dd>
                  </dl>
                  <ul role="list" className="mt-8 flex space-x-12">
                    <li>
                      <a className="text-white hover:text-primaryColor" href="#">
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                      <button
                        type="submit"
                        className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-primaryDark px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto"
                      >
                        Submit
                      </button>
                    </div>
